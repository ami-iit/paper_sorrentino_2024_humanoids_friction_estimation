function reduce_and_resample_dataset(dataset_folder, moving_joint, associated_joints)
    ...
    diag_cov = dictionary('torso_roll' , {[1e-1, 1e-1, 1e1]}, ...
                          'torso_yaw'  , {[1e-1, 1e1, 1e1]}, ...
                            'l_hip_pitch', {[1e-5, 1e-4, 1e3]}, ...
                            'l_hip_roll' , {[1e-5, 1e-4, 1e3]}, ...
                            'l_hip_yaw'  , {[1e-5, 1e-4, 1e0]}, ...
                            'l_knee'     , {[1e-5, 1e-4, 1e4]}, ...
                            'l_ankle_pitch', {[1e-5, 1e-3, 1e3]}, ...
                            'l_ankle_roll', {[1e-5, 1e-4, 1e3]}, ...
                            'r_hip_pitch', {[1e-5, 1e-4, 1e3]}, ...
                            'r_hip_roll' , {[1e-5, 1e-4, 1e3]}, ...
                            'r_hip_yaw'  , {[1e-5, 1e-4, 1e0]}, ...
                            'r_knee'     , {[1e-5, 1e-4, 1e4]}, ...
                            'r_ankle_pitch', {[1e-5, 1e-3, 1e3]}, ...
                            'r_ankle_roll', {[1e-5, 1e-4, 1e3]});

    meas_cov = dictionary('torso_roll' , 1e-4, ...
                          'torso_yaw'  , 1e-4, ...
                            'l_hip_pitch', 1e-4, ...
                            'l_hip_roll' , 1e-4, ...
                            'l_hip_yaw'  , 1e-4, ...
